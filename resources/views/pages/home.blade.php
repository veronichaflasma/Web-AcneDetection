...
@section('content')
    <div>
        <div class="page-hero bg-image overlay-dark" style="background-image: url({{ asset('img/bg_image_1.jpg') }});">
            <div class="hero-section">
                <div class="container text-center wow zoomIn">
                    <span class="subhead">Let's make your face bright</span>
                    <h1 class="display-4">Know Your Acne Severity, Make it Glow!</h1>
                    <a href="#" class="btn btn-primary">Let's Analyst</a>
                </div>
            </div>
        </div>
        ...
        <div class="page-section bg-light">
            <div class="container">
                <h1 class="text-center wow fadeInUp">Latest Tips</h1>
                <div class="row mt-5">
                    ...
                    <div class="col-lg-4 py-2 wow zoomIn">
                        <div class="card-blog">
                            ...
                            <div class="body">
                                <h5 class="post-title"><a href="blog-details.html">Recovery Room: Tips beyond the
                                        pandemic</a></h5>
                                <div class="site-info">
                                    <div class="avatar mr-2">
                                        <div class="avatar-img">
